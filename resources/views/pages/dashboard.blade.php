                ...
                <div class="col-lg-6 col-xxl-4">
                    ...
                    <div class="card card-custom bg-gray-100 card-stretch gutter-b">
                        ...
                        <div class="card-header border-0 bg-danger py-5">
                            @if (session('guru'))
                                <h3 class="card-title font-weight-bolder text-white">{{ $guru->nama_guru }}</h3>
                            @elseif(session('siswa'))
                                <h3 class="card-title font-weight-bolder text-white">{{ $siswa->nama }}</h3>
                            @endif
                            {{-- <h3 class="card-title font-weight-bolder text-white">login ini guru</h3> --}}
